...
*/
console.log(createMenuItem("Cold Brew", 5, "Drinks"))
console.log(createMenuItem("Nachos", 12, "Lunch"))
...
let newObj = {
  name: "Dalian",
  rating: 10, 
  feedback: "finally getting the hang of JS!"
};
reviews.push(newObj);
console.log(reviews);
...
function getLastReview(array) {
  ...
  const lastReview = (`${reviews[lastIndex].name} gave the restaurant a ${reviews[lastIndex].rating} star review, and their feedback was: ${reviews[lastIndex].feedback}`)
  return lastReview
} 
